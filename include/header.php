		...
		<div id="top-bar">
			...
			<div class="container clearfix">
				...
				<div class="col_half nobottommargin d-none d-md-block">
					...
					<p class="nobottommargin"><strong>Call:</strong> 1800-547-2145 | <strong>Email:</strong> info@hiphop.pk</p>
				...
				<div class="col_half col_last fright nobottommargin">
					...
					<div class="top-links">
						<ul>
							...
							<a href="#" id="top-cart-trigger" style="width: 100px"> View Cart<i class="icon-shopping-cart"></i><span>5</span></a>
					...
					<div class="container clearfix">
						...
						<div id="primary-menu-trigger"><i class="icon-reorder"></i></div>
							...
							<ul>
								...
								<li><a href="#"><div>Mini Boy</div><span>Out of the Box</span></a>
								<div class="mega-menu-content style-2 clearfix">
									<ul class="mega-menu-column col-lg-6">
										<li class="mega-menu-title"><a href="#"><div> <i class="icon-thumbs-up21"></i> Special</div></a>
											<ul>
												<li><a href="#"><div>Sales</div></a></li>
												<li><a href="#"><div>New Arrivals</div></a></li>
												<li><a href="#"><div>Featured</div></a></li>
											</ul>
										</li>
									</ul>
									<ul class="mega-menu-column col-lg-6">
										<li class="mega-menu-title"><a href="#"><div><i class="icon-child"></i> Child Clothing</div></a>
											<ul>
